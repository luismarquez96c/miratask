				...
				<div id="detail_matter" class="x_content">
					<div class="tabPanelWrap" role="tabpanel" data-example-id="togglable-tabs">
						<ul id="opciones" class="nav nav-tabs bar_tabs" role="tablist">
							<li id="tab1" class="tabLink2"><a href="#mcontenido1" id="home-tab" role="tab" data-toggle="tab" aria-expanded="true"> <i class="fa fa-balance-scale"></i><?php echo $this->lang->line('matters_detail_5'); ?></a></li>
							<!-- <li id="tab2" class="tabLink2"><a href="#tcontenido2" role="tab" data-toggle="tab"><i class="fa fa-check-square-o"></i> Check List</a></li> -->
							<li id="tab3" class="tabLink2"><a href="#tcontenido3" role="tab" data-toggle="tab" aria-expanded="false"><i class="fa fa-list-alt"></i><?php echo $this->lang->line('matters_detail_6'); ?></a></li>
