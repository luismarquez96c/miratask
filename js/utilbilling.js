	...
	function add_entry(id_matter,id_entry,no_invoice=""){
		...
		$.post(base_app+"Billing/time_expense_modal?from=billing&invoice="+no_invoice,{id_matter:id_matter,id_entry:id_entry},function(response){
